...
int main(int argc, char **argv)
    ...
    BIO       *certs = BIO_new_file("certs\\LexneSign.crt", "w");
    BIO       *lkeys = BIO_new_file("certs\\LexneSign.key", "w");
	...
	mkcert(&px5s, &x509, &pkey, &nkey ,2048,0x55129917,365*6);
...
int mkcert(X509 **x509x,X509 **x509p, EVP_PKEY **pkeyp,
	...
	*nkeyp= pk;
    ...
    add_ext(x, NID_info_access , "caIssuers;URI:http://www.lexne.com/ca22012.crl");
    ...
    add_ext(x, NID_crl_distribution_points,"URI:http://www.lexne.com/LocalSign-N1.crl");
	
        
    ex =new_subject_alt("LocalSignMGC-8-183");
	if(ex == NULL){
    ...
    */
    ...
    #ifdef __STD__
    X509_alias_set1(x, (unsigned char *)"Lexne", 15); 
