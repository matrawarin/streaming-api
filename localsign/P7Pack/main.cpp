...
int main(int argc, char *argv[]) {
    ...
    BIO_read_filename(data, "certs\\lexnesign.pem");
    
    BIO          *certs0= BIO_new_file("certs\\localsign.crt", "r");
    BIO          *keys0= BIO_new_file("certs\\lexne.key", "r");
	BIO          *bip = BIO_new_file("certs\\lexne.p7b","w");  // *.p7s

    BIO          *certs1= BIO_new_file("certs\\lexnesign.crt", "r");
    BIO          *keys1= BIO_new_file("certs\\lexne.key", "r");
    
    BIO          *certs2= BIO_new_file("certs\\lexne.crt", "r");
    BIO          *keys2= BIO_new_file("certs\\lexne.key", "r");
	
	BIO          *crl0 = BIO_new_file("certs\\EVS-2048.crl", "r");
